...
use crate::constants::{
    ...
    DEFLATE_NUM_PRECODE_SYMS, DEFLATE_PRECODE_LENS_PERMUTATION, DEFLATE_MAX_LENS_OVERRUN,
...
pub(crate) struct DeflateHeaderTables {
    ...
    pub(crate) lens:
        [u8; DEFLATE_NUM_LITLEN_SYMS + DEFLATE_NUM_OFFSET_SYMS + DEFLATE_MAX_LENS_OVERRUN],
}
