...
pub const INIT_LAST_COEFF: [u8; 54] = [
    110, 110, 124, 125, 140, 153, 125, 127, 140, 109, 111, 143, 127, 111, 79, 108, 123, 63, // B
...
pub const INIT_COEFF_ABS_G1: [u8; 72] = [
...
pub const INIT_COEFF_ABS_G2: [u8; 18] = [
